...
export const Dashboard = () => {
  ...
  return <div className="space-y-6">
      ...
      <motion.div variants={container} initial="hidden" animate="show" className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {kpiCards.map((card, index) => <motion.div key={card.title} variants={item}>
        ...
        <Card className="border-0 bg-gradient-card">
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              ...
              count: 0,
              color: 'bg-warning'
            }].map(status => <div key={status.label} className="flex items-center justify-between">
      ...
      duration: 0.5
        ...
        <Card className="border-0 bg-gradient-primary text-white cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-glow">
          <CardContent className="p-6">
            ...
            <p className="text-sm opacity-90">Create a new quotation for your customers</p>
          </CardContent>
        </Card>
